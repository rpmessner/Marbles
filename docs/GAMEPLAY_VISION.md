...
\*_Mouse + Keyboard:_ (Quick initial prototyping)\*
...
**Controller (First class support, everything else is secondary):**
...
| **Physics**  | 2D sliding physics   | Full 3D Jolt physics            |
...
- ✅ Ensure physics feels _right_ (realistic collisions)
...
**The Dream:**
This becomes **the** definitive marble game. When people think of beautiful marbles in a game, they think of this. Like how people think of Rocket League for physics-based car soccer, we want this to be _the_ physics-based marble game.
